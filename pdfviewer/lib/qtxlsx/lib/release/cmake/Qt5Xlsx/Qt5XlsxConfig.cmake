...
if (NOT TARGET Qt5::Xlsx)
    ...
    set_property(TARGET Qt5::Xlsx PROPERTY INTERFACE_QT_PLUGIN_TYPES "")
    ...
    if (_Qt5Xlsx_PRIVATE_DIRS_EXIST)
        ...
        if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::XlsxPrivate)
            add_library(Qt::XlsxPrivate INTERFACE IMPORTED)
            set_target_properties(Qt::XlsxPrivate PROPERTIES
                INTERFACE_LINK_LIBRARIES "Qt5::XlsxPrivate"
            )
        endif()
    endif()
    ...
    if (QT5_STRICT_PLUGIN_GLOB OR Qt5Xlsx_STRICT_PLUGIN_GLOB)
        file(GLOB pluginTargets "${CMAKE_CURRENT_LIST_DIR}/Qt5Xlsx_*Plugin.cmake")
    else()
        file(GLOB pluginTargets "${CMAKE_CURRENT_LIST_DIR}/Qt5Xlsx_*.cmake")
    endif()
...
# Add a versionless target, for compatibility with Qt6.
if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND TARGET Qt5::Xlsx AND NOT TARGET Qt::Xlsx)
    add_library(Qt::Xlsx INTERFACE IMPORTED)
    set_target_properties(Qt::Xlsx PROPERTIES
        INTERFACE_LINK_LIBRARIES "Qt5::Xlsx"
    )
endif()
