 ...
 *
 * Windows: 系统下载文件夹\PdfDownloads
 * Linux/Mac: 用户主目录/PdfDownloads
 */
QString Settings::getDefaultDownloadPath()
{
    ...
    return
        QStandardPaths::locate(QStandardPaths::DownloadLocation, QString(), QStandardPaths::LocateDirectory) + "PdfDownloads";
#else
    // Linux/Mac 系统：使用用户主目录
    return QDir::homePath() + QDir::separator() + "PdfDownloads";
#endif
}
